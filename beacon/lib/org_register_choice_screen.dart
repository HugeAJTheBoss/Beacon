...
// Navigator.push (route to a new screen): https://www.geeksforgeeks.org/routes-and-navigator-in-flutter/
  ...
  // Stack (layer widgets on top of each other): https://www.geeksforgeeks.org/flutter/flutter-stack-widget/
  // Align (position a child within its parent): https://www.geeksforgeeks.org/flutter/flutter-align-widget/
  Widget _buildProviderButton({
    required String label,
    required String assetPath,
  }) {
  // SizedBox (fixed dimensions): https://www.geeksforgeeks.org/flutter-sizedbox-widget/
    return SizedBox(
      height: 52,
      // OutlinedButton (border-style button): https://www.geeksforgeeks.org/flutter-material-widget-outlined-button-class/
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Divider (horizontal rule between sections): https://www.geeksforgeeks.org/flutter-divider-widget-with-example/
                        const Row(
                          children: [
